...
{
    public class AppLogoIdAjaxDropdownController : Controller
    {
        ...
        public ActionResult GetItems(int? v, int? appId)
        {
            ...
            list.AddRange(repo.Where(o => o.ApplicationId == appId && o.MediaType == "Image" && o.Module=="Index" ).ToArray().Select(o => new SelectableItem
            {
