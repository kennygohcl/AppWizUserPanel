...
{
    public class AppVideoIdAjaxDropdownController : Controller
    {
        private IRepo<MediaDocument> repo;
        public AppVideoIdAjaxDropdownController(IRepo<MediaDocument> repo)
        {
            this.repo = repo;
        }
        ...
        public ActionResult GetItems(int? v, int? appId)
        {
            ...
            list.AddRange(repo.Where(o => o.ApplicationId == appId && o.MediaType == "Video" && o.Module=="Index" ).ToArray().Select(o => new SelectableItem
            {
