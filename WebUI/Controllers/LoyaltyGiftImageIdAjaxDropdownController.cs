...
{
    public class LoyaltyGiftImageIdAjaxDropdownController : Controller
    {
        private IRepo<MediaDocument> repo;
        public LoyaltyGiftImageIdAjaxDropdownController(IRepo<MediaDocument> repo)
        {
            this.repo = repo;
        }
        ...
        public ActionResult GetItems(int? v, int? appId)
        {
            ...
            list.AddRange(repo.Where(o => o.ApplicationId == appId && o.MediaType == "Image" && o.Module=="Loyalty" ).ToArray().Select(o => new SelectableItem
            {
