...
{
    public class MediaLinkImageIdAjaxDropdownController : Controller
    {
        private IRepo<MediaDocument> repo;
        public MediaLinkImageIdAjaxDropdownController(IRepo<MediaDocument> repo)
        {
            this.repo = repo;
        }
        ...
        public ActionResult GetItems(int? v, int? appId)
        {
            ...
            list.AddRange(repo.Where(o => o.ApplicationId == appId && o.MediaType == "Image" && o.Module=="RetailerInfo" ).ToArray().Select(o => new SelectableItem
            {
