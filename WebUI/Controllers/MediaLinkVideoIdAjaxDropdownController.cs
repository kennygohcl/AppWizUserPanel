...
{
    public class MediaLinkVideoIdAjaxDropdownController : Controller
    {
        ...
        public ActionResult GetItems(int? v, int? appId)
        {
            ...
            list.AddRange(repo.Where(o => o.ApplicationId == appId && o.MediaType == "Video" && o.Module == "RetailerInfo").ToArray().Select(o => new SelectableItem
            {
