...
{                
    public class NotificationGroupingAjaxDropdownController : Controller
    {
        private readonly IRepo<NotificationGrouping> repo;

        public NotificationGroupingAjaxDropdownController(IRepo<NotificationGrouping> repo)
        {
            this.repo = repo;
        }
